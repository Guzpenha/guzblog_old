...
![alt](/images/queryperformanceprediction.png){: .center-image}
...
![alt](/images/documentperformanceprediction.png){: .center-image}
...
The evaluations are regarding the following criterias: Relevance to ECIR | Originality of Work | Proposed Method/Solution/Analysis/Application | Methodology, Analysis, and Claims | Adequacy of Background and Citations | Quality of Presentation | Impact of Ideas, Results, Demo|
